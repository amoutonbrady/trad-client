...
export const Upload: Component<Props> = (props) => {
  ...
  return (
    <label
      for={id}
      class="w-full h-64 bg-gray-050 rounded-lg border-2 border-gray-300 border-dashed flex justify-center items-center transition-colors duration-300 text-gray-300 hover:text-gray-500 relative"
